...
document.getElementById('Calculate-btn').addEventListener('click', function () {
    ...
    else if (newInputValue1 < 0 && newInputValue2 < 0 && newInputValue3 < 0 && incomeField < 0) {
    ...
    else if (totalExpensesAmount > incomeField) {
...
function handleError() {
    ...
    // handleError();
    if (totalBalance > incomeField && totalExpenses > incomeField) {
        // negativeError.style.display = 'block';
        // incomeField.value = '';
